...
extension PDFCreator {
    func generatClassicLayoutNoImagePDF(context:UIGraphicsPDFRendererContext) {
        ...
        //add fullname
        lastDrawPosition = self.addText(context,text: resume.name!,
                                        pageRect: pageRect,
        ...
        for case let (iconName,text) as (String,String) in textList {
            ...
            lastDrawPosition = self.addText(context, text: text,
                                            pageRect: pageRect,
                                            position: currentDrawPosition,
                                            preferWidth: preferFullPageWidth - iconRect.origin.x - iconRect.size.width,
